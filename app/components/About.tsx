      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="space-y-8">
            <div>
              <p className="text-sm tracking-[0.3em] text-gray-600 dark:text-gray-600 font-light mb-4">OUR STORY</p>
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-600 leading-6 font-extralight text-base" style={{ fontFamily: 'var(--font-body)' }}>
          <p>
